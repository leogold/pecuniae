...
while True:
    ...
    if k%256 == 27:
        ...
        img_name = "Bur_images/test/color/good/" + timestr + "GoodBur.png".format(img_counter)
        img_name_gray = "Bur_images/test/gray/good/" + timestr + "GrayGoodBur.png".format(img_counter)
